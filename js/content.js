...
const IMG_POMME          = "<img alt='Consommation Journalière' class='o_vAlign' src='images/icone/icone_pomme.gif' height='18' title='Consommation Journalière' />";
const IMG_MAT            = "<img height='18' src='images/icone/icone_bois.gif'/>";
const IMG_COEUR          = "<img height='18' width='18' src='images/icone/icone_coeur.gif' class='o_vAlign'/>";
const IMG_ATT            = "<img alt='Dégâts en attaque :' class='o_vAlign' src='images/icone/icone_degat_attaque.gif' height='18' title='Dégâts en attaque :' />";
const IMG_DEF            = "<img alt='Dégâts en défense :' class='o_vAlign' src='images/icone/icone_degat_defense.gif' height='18' title='Dégâts en défense :' />";
...
const IMG_COPY           = "<img class='cliquable' title='Copier/Coller une armée' style='position:relative;top:3px' src='images/icone/feuille.gif' width='14' height='17'>";
// Image pour l'extension
const O_ACCEPTER         = chrome.extension.getURL("images/accepter.png");
const O_REFUSER          = chrome.extension.getURL("images/refuser.png");
const O_CHANGE           = chrome.extension.getURL("images/change.png");
const O_ACTUALISER       = chrome.extension.getURL("images/actualize_on_01.png");
const O_CRAYON			 = chrome.extension.getURL("images/crayon.gif");
const O_CROIX			 = chrome.extension.getURL("images/croix.png");
const O_COPY			 = chrome.extension.getURL("images/copy.png");
const O_HISTORIQUE		 = chrome.extension.getURL("images/historique.png");
const O_LIVRAISON		 = chrome.extension.getURL("images/livraison.png");
const O_NONXP			 = chrome.extension.getURL("images/nonXP.png");
const O_QUESTION		 = chrome.extension.getURL("images/question.png");
const O_RADAR			 = chrome.extension.getURL("images/radar.png");
const O_SPRITE_MENU		 = chrome.extension.getURL("images/sprite_menu.png");
const O_UTILITAIRE		 = chrome.extension.getURL("images/utilitaire.png");
const O_UTILITY			 = chrome.extension.getURL("images/utility.png");
const O_DOWN			 = chrome.extension.getURL("images/down.png");
const O_UP				 = chrome.extension.getURL("images/up.png");
const O_OUTIIIL			 = chrome.extension.getURL("images/outiiil.png");
