    ...
    */
    toHTMLMessagerie()
    {
        let tdp = monProfil.getTDP(),
            ...
            bonusVie = this._armeeAp.getTotalVie(monProfil.niveauRecherche[1], 0, 0) - this._armeeAv.getTotalVie(monProfil.niveauRecherche[1], 0, 0),
    ...
    */
    toHTMLBoite(bVisible)
    {
		...
		let html = `<tr ${bVisible ? "" : "style='display:none'"}><td><img height='20' src='images/icone/fourmi.png'/></td><td>${numeral(this._armeeAv.getSommeUnite()).format()}</td><td><img height='20' src='images/icone/fourmi.png'/></td><td>${numeral(diffNbr).format("+0,0")} (${numeral(diffNbr / this._armeeAv.getSommeUnite()).format("+0.00%")})</td><td><img height='20' src='images/icone/fourmi.png'/></td><td>${numeral(this._armeeAp.getSommeUnite()).format()}</td></tr>
            <tr ${bVisible ? "" : "style='display:none'"}><td><img height='20' src='images/icone/icone_coeur.gif'/></td><td>${numeral(this._armeeAv.getBaseVie()).format()}</td><td><img height='20' src='images/icone/icone_coeur.gif'/></td><td>${numeral(diffVie).format("+0,0")} (${numeral(diffVie / this._armeeAv.getBaseVie()).format("+0.00%")})</td><td><img height='20' src='images/icone/icone_coeur.gif'/></td><td>${numeral(this._armeeAp.getBaseVie()).format()}</td></tr>
			<tr ${bVisible ? "" : "style='display:none'"}><td><img height='20' src='images/icone/icone_degat_attaque.gif'/></td><td>${numeral(this._armeeAv.getBaseAtt()).format()}</td><td><img height='20' src='images/icone/icone_degat_attaque.gif'/></td><td>${numeral(diffAtt).format("+0,0")} (${numeral(diffAtt / this._armeeAv.getBaseAtt()).format("+0.00%")})</td><td><img height='20' src='images/icone/icone_degat_attaque.gif'/></td><td>${numeral(this._armeeAp.getBaseAtt()).format()}</td></tr>
			<tr ${bVisible ? "" : "style='display:none'"}><td><img height='20' src='images/icone/icone_degat_defense.gif'/></td><td>${numeral(this._armeeAv.getBaseDef()).format()}</td><td><img height='20' src='images/icone/icone_degat_defense.gif'/></td><td>${numeral(diffDef).format("+0,0")} (${numeral(diffDef / this._armeeAv.getBaseDef()).format("+0.00%")})</td><td><img height='20' src='images/icone/icone_degat_defense.gif'/></td><td>${numeral(this._armeeAp.getBaseDef()).format()}</td></tr>`;
        return html;
    }
}
