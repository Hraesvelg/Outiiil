...
class Boite
{
    ...
    */
    afficher()
    {
        ...
        if(!$("#" + this._id).length){
            ...
            $("#" + this._id).css({top : (Math.random() * 100 + 50) + "px", left : (Math.random() * 250 + 100) + "px"}).draggable({stack: "div"});
            bCreate = true;
        }
	...
	*/
	css()
	{
        ...
        $(".o_content p, .o_content .o_label, .o_content table").css("color", monProfil.parametre["couleurTexte"].valeur);
        return this;
	}
	/**
