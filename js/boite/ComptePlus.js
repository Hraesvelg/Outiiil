...
class BoiteComptePlus
{
    constructor(parametre = {})
    {
        ...
        *
        */
        this._ponte = parametre.ponte || [];
        /**
        *
        */
        this._startPonte = parametre.startPonte || 0;
        /**
        *
        */
        this._construction = parametre.construction || "";
        /**
        *
        */
        this._expConstruction = parametre.expConstruction || 0;
        /**
        *
        */
        this._startConstruction = parametre.startConstruction || 0;
        /**
        *
        */
        this._recherche = parametre.recherche || "";
        /**
        *
        */
        this._expRecherche = parametre.expRecherche || 0;
        /**
        *
        */
        this._startRecherche = parametre.startRecherche || 0;
        /**
        *
        */
        this._attaque = parametre.attaque || [];
        /**
        *
        */
        this._startAttaque = parametre.startAttaque || 0;
        /**
        *
        */
        this._convoi = parametre.convoi || [];
        /**
        *
        */
        this._startConvoi = parametre.startConvoi || 0;
        /**
        *
        */
        this._chasse = parametre.chasse || [];
        /**
        *
        */
        this._startChasse = parametre.startChasse || 0;
    }
    /**
    *
    */
	...
	*/
	afficher()
	{
        let visible = sessionStorage.getItem("boiteActive");
        if(!Utils.comptePlus){
            // Ajout du contenue
    ...
    */
    verifierDonnees()
    {
        ...
        localStorage.setItem("outiiil_data", JSON.stringify(this));
        return this;
    }
    /**
    *
