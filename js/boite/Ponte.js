...
class BoitePonte extends Boite
{
    constructor()
    {
        ...
        super("o_boitePonte", "Lanceur de Ponte", `<div id='o_ponteContent'><table class='o_maxWidth'>
                ...
                <tr><td>${NOM_RAC_UNITE[0]}</td><td>${parseFloat((TEMPS_UNITE[0] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre0'/></td><td><input name='o_jour0' value='0' size='3'/></td><td><input name='o_heure0' value='0' size='2'/></td><td><input name='o_minute0' value='0' size='2'/></td><td><input name='o_seconde0' value='0' size='2'/></td><td class='cursor'><img id='o_lancer0' height='20' src='images/icone/fourmi.png' alt='Lancer'></td></tr>
                <tr><td>${NOM_RAC_UNITE[1]}</td><td>${parseFloat((TEMPS_UNITE[1] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre1'/></td><td><input name='o_jour1' value='0' size='3'/></td><td><input name='o_heure1' value='0' size='2'/></td><td><input name='o_minute1' value='0' size='2'/></td><td><input name='o_seconde1' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[7] >= 1 ? "<img id='o_lancer1' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[2]}</td><td>${parseFloat((TEMPS_UNITE[2] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre2'/></td><td><input name='o_jour2' value='0' size='3'/></td><td><input name='o_heure2' value='0' size='2'/></td><td><input name='o_minute2' value='0' size='2'/></td><td><input name='o_seconde2' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[7] >= 3 ? "<img id='o_lancer2' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[3]}</td><td>${parseFloat((TEMPS_UNITE[3] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre3'/></td><td><input name='o_jour3' value='0' size='3'/></td><td><input name='o_heure3' value='0' size='2'/></td><td><input name='o_minute3' value='0' size='2'/></td><td><input name='o_seconde3' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[8] >= 4 ? "<img id='o_lancer3' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[4]}</td><td>${parseFloat((TEMPS_UNITE[4] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre4'/></td><td><input name='o_jour4' value='0' size='3'/></td><td><input name='o_heure4' value='0' size='2'/></td><td><input name='o_minute4' value='0' size='2'/></td><td><input name='o_seconde4' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[7] >= 7 ? "<img id='o_lancer4' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[5]}</td><td>${parseFloat((TEMPS_UNITE[5] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre5'/></td><td><input name='o_jour5' value='0' size='3'/></td><td><input name='o_heure5' value='0' size='2'/></td><td><input name='o_minute5' value='0' size='2'/></td><td><input name='o_seconde5' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[8] >= 9 ? "<img id='o_lancer5' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[6]}</td><td>${parseFloat((TEMPS_UNITE[6] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre6'/></td><td><input name='o_jour6' value='0' size='3'/></td><td><input name='o_heure6' value='0' size='2'/></td><td><input name='o_minute6' value='0' size='2'/></td><td><input name='o_seconde6' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[7] >= 10 && monProfil.niveauRecherche[7] >= 5 ? "<img id='o_lancer6' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[8]}</td><td>${parseFloat((TEMPS_UNITE[8] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre7'/></td><td><input name='o_jour7' value='0' size='3'/></td><td><input name='o_heure7' value='0' size='2'/></td><td><input name='o_minute7' value='0' size='2'/></td><td><input name='o_seconde7' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[7] >= 11 && monProfil.niveauRecherche[8] >= 1 ? "<img id='o_lancer7' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[9]}</td><td>${parseFloat((TEMPS_UNITE[9] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre8'/></td><td><input name='o_jour8' value='0' size='3'/></td><td><input name='o_heure8' value='0' size='2'/></td><td><input name='o_minute8' value='0'  size='2'/></td><td><input name='o_seconde8' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[8] >= 13 && monProfil.niveauRecherche[8] >= 5 ? "<img id='o_lancer8' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[10]}</td><td>${parseFloat((TEMPS_UNITE[10] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre9'/></td><td><input name='o_jour9' value='0' size='3'/></td><td><input name='o_heure9' value='0' size='2'/></td><td><input name='o_minute9' value='0' size='2'/></td><td><input name='o_seconde9' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[8] >= 17 ? "<img id='o_lancer9' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[11]}</td><td>${parseFloat((TEMPS_UNITE[11] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre10'/></td><td><input name='o_jour10' value='0' size='3'/></td><td><input name='o_heure10' value='0' size='2'/></td><td><input name='o_minute10' value='0' size='2'/></td><td><input name='o_seconde10' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[8] >= 23 && monProfil.niveauRecherche[7] >= 15 ? "<img id='o_lancer10' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[13]}</td><td>${parseFloat((TEMPS_UNITE[13] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre11'/></td><td><input name='o_jour11' value='0' size='3'/></td><td><input name='o_heure11' value='0' size='2'/></td><td><input name='o_minute11' value='0' size='2'/></td><td><input name='o_seconde11' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[7] >= 25 && monProfil.niveauRecherche[9] >= 4 ? "<img id='o_lancer11' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
                <tr><td>${NOM_RAC_UNITE[14]}</td><td>${parseFloat((TEMPS_UNITE[14] * Math.pow(0.9, tdp)).toPrecision(2))}</td><td><input value='0' size='15' name='o_nombre12'/></td><td><input name='o_jour12' value='0' size='3'/></td><td><input name='o_heure12' value='0' size='2'/></td><td><input name='o_minute12' value='0' size='2'/></td><td><input name='o_seconde12' value='0' size='2'/></td><td class='cursor'>${(monProfil.niveauConstruction[8] >= 28 && monProfil.niveauRecherche[9] >= 7 ? "<img id='o_lancer12' height='20' src='images/icone/fourmi.png' alt='Lancer'>" : "")}</td></tr>
    ...
    */
	...
	{
        if(super.afficher()){
            $("#o_boitePonte").draggable("option", "cancel" , ".ui-spinner");
	...
	*/
	event()
	{
		...
		$("input[name^='o_nombre']").on("input spin", (e, ui) => {
			...
			this.refreshTemps(parseInt($(e.currentTarget).attr("name").replace("o_nombre", "")), nombre * (TEMPS_UNITE[NOM_RAC_UNITE.indexOf($(e.currentTarget).closest("tr").find("td:first").text())] * Math.pow(0.9, ~~($("#o_niveauTDP").spinner("value")))));
		...
		$("input[name^='o_seconde']").on("input spin", (e, ui) => {
			...
			this.refreshNombre(unite, -1, -1, -1, seconde);
		});
		$("input[name^='o_minute']").on("input spin", (e, ui) => {
			...
			// mise à jour du nombre
			this.refreshNombre(unite, -1, -1, minute, -1);
		});
		$("input[name^='o_heure']").on("input spin", (e, ui) => {
			...
			// mise à jour du nombre
			this.refreshNombre(unite, -1, heure, -1, -1);
		});
		$("input[name^='o_jour']").on("input spin", (e, ui) => {
			let jour = ui ? ui.value : $(e.currentTarget).spinner("value");
			// mise à jour du nombre
			this.refreshNombre(parseInt($(e.currentTarget).attr("name").replace("o_jour", "")), jour, -1, -1, -1);
		...
		$("#o_niveauTDP").on("input spin", (e, ui) => {
			...
			$("input[name^='o_nombre']").each((i, elt) => { // Pour chaque unité on met à jour le temps
				...
				$(elt).parent().parent().prev().text(parseFloat((TEMPS_UNITE[unite] * Math.pow(0.9, tdp)).toPrecision(2)));
				let nombre = $(elt).spinner("value");
				// mise à jour du temps
				if(nombre)
					this.refreshTemps(unite, nombre * (TEMPS_UNITE[unite] * Math.pow(0.9, tdp)));
			});
		});
		// Lancer les pontes
		$("img[id^=o_lancer]").click((e) => {
			...
			if(nombre){
                ...
                $.ajax({url : "http://" + Utils.serveur + ".fourmizzz.fr/Reine.php"}).then((data) => {
                    ...
                    donnees["typeUnite"] = (unite ? "unite" + unite : "ouvriere");
                    donnees["input_cout_nombre" + (unite ? '' : unite)] = nombre;
	...
	*/
	refreshNombre(unite, jour, heure, minute, seconde)
	{
