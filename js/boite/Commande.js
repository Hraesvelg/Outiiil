    ...
    */
    getForm()
    {
        ...
        $("#" + this._id).append(`<div class="o_commandeForm"><form id="o_form${this._commande.id}">
            ...
            <div class="group"><input name="o_dateCommande" class="o_input" type="text" value="${this._commande.dateSouhaite ? moment(this._commande.dateSouhaite).format("YYYY-MM-DD") : ""}" required/><span class="o_inputHighlight"></span><span class="o_inputBar"></span><label class='o_label'>Pour le*</label></div>
            <div class="group"><input name="o_dateApres" class="o_input" type="text" value="${this._commande.dateApres ? moment(this._commande.dateApres).format("YYYY-MM-DD") : ""}" required/><span class="o_inputHighlight"></span><span class="o_inputBar"></span><label class='o_label'>&Agrave; Partir du</label></div>
